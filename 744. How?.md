This page has detailed how I solve the [744. What? Where? When?](./744.%20What%3F%20Where%3F%20When%3F.md)
...
To test my idea and to double check my calculation above, I wrote the following piece of code which replicates the process but struggles when n is bigger than 10.
```python
class Node:
...
From [List of integer sequences](https://github.com/doudou-h/project-euler-solution/edit/main/744.%20How%3F.md), I found [Catalan number](https://en.wikipedia.org/wiki/Catalan_number). However, the following code doesn't work when n is larger than 520. 
