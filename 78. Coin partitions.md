...
Also, ![eq](https://latex.codecogs.com/gif.latex?p(n)=0&space;\texttt{&space;for&space;}&space;n&space;<&space;0). Notice that, `g(k)` is a power function therefore much less operations needed to obtain `p(n)`.
